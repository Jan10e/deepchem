...
from deepchem.models.torch_models.layers import EncoderRNN, DecoderRNN, DecoderRNNParallel, VariationalRandomizer
...
class SeqToSeqParallel(nn.Module):
    """Implements sequence to sequence translation models.
    ...
    def __init__(self,
        ...
        """
        super(SeqToSeqParallel, self).__init__()
        self._variational = variational
        self.encoder = EncoderRNN(n_input_tokens, embedding_dimension,
                                  encoder_layers, dropout)
        self.decoder = DecoderRNNParallel(embedding_dimension, n_output_tokens,
                                  decoder_layers, max_output_length, batch_size)
        if variational:
            self.randomizer = VariationalRandomizer(embedding_dimension,
                                                    annealing_start_step,
...
class SeqToSeqModelParallel(TorchModel):
    """Implements sequence to sequence translation models.
    ...
    def __init__(self,
        ...
        self.model: nn.Module = SeqToSeqParallel(
            n_input_tokens=self._n_input_tokens,
            n_output_tokens=self._n_output_tokens,
            max_output_length=self._max_output_length,
            encoder_layers=encoder_layers,
